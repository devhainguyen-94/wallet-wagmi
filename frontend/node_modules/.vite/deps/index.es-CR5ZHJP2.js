import {
  ...
  numberToHex,
  toHex
} from "./chunk-3DNX4NIZ.js";
import {
  detect
} from "./chunk-5I6YCUI7.js";
import {
  require_events
} from "./chunk-AOCRQWGW.js";
import "./chunk-5NJIJ27I.js";
import "./chunk-Y3XLXHWY.js";
import {
  keccak_256
} from "./chunk-5XO6SVS4.js";
import "./chunk-2JMWQKYM.js";
import "./chunk-PAVQGNIV.js";
import {
  __commonJS,
  __esm,
  __export,
...
function __generator(thisArg, body) {
  ...
  function step(op) {
    ...
    while (_5)
      try {
        if (f6 = 1, y7 && (t = op[0] & 2 ? y7["return"] : op[0] ? y7["throw"] || ((t = y7["return"]) && t.call(y7), 0) : y7.next) && !(t = t.call(y7, op[1])).done)
          return t;
        if (y7 = 0, t)
          op = [op[0] & 2, t.value];
        switch (op[0]) {
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-U4Z6QCWW.js");
  const signature_ = (() => {
...
var An = class extends xn {
  ...
  digestInto(e2) {
    ...
    for (let l7 = 0; l7 < D4; l7++)
      u4.setUint32(4 * l7, c7[l7], s3);
  }
  digest() {
  ...
  return function(u4, i4) {
    ...
    for (; !u4.eql(p6, u4.ONE); ) {
      if (u4.eql(p6, u4.ZERO))
        return u4.ZERO;
      let w7 = 1;
      for (let g6 = u4.sqr(p6); w7 < D4 && !u4.eql(g6, u4.ONE); w7++)
        g6 = u4.sqr(g6);
  ...
  return { constTimeNegate: zt, hasPrecomputes(n5) {
    ...
    for (let l7 = 0; l7 < a3; l7++) {
      ...
      if (o6 === Se)
        break;
      let w7 = Number(o6 & i4);
      if (o6 >>= c7, w7 > u4 && (w7 -= D4, o6 += gt), w7 === 0)
        continue;
...
function br(t, e2, n5, r3) {
  ...
  for (let l7 = D4; l7 >= 0; l7 -= a3) {
    ...
    let p6 = o6;
    for (let w7 = i4.length - 1, h6 = o6; w7 > 0; w7--)
      h6 = h6.add(i4[w7]), p6 = p6.add(h6);
    if (c7 = c7.add(p6), l7 !== 0)
      for (let w7 = 0; w7 < a3; w7++)
        c7 = c7.double();
  }
  return c7;
}
...
function Ir(t, e2) {
  ...
  function l7(h6) {
    ...
    if (h6.length === 0)
      return "";
    for (var g6 = 0, S5 = 0, v8 = 0, L6 = h6.length; v8 !== L6 && h6[v8] === 0; )
      v8++, g6++;
    for (var d6 = (L6 - v8) * c7 + 1 >>> 0, m5 = new Uint8Array(d6); v8 !== L6; ) {
      for (var F4 = h6[v8], q3 = 0, z6 = d6 - 1; (F4 !== 0 || q3 < S5) && z6 !== -1; z6--, q3++)
        F4 += 256 * m5[z6] >>> 0, m5[z6] = F4 % u4 >>> 0, F4 = F4 / u4 >>> 0;
      if (F4 !== 0)
        throw new Error("Non-zero carry");
      S5 = q3, v8++;
    }
    for (var I4 = d6 - S5; I4 !== d6 && m5[I4] === 0; )
      I4++;
    for (var O8 = i4.repeat(g6); I4 < d6; ++I4)
      O8 += t.charAt(m5[I4]);
    return O8;
  }
  function p6(h6) {
    ...
    var g6 = 0;
    if (h6[g6] !== " ") {
      for (var S5 = 0, v8 = 0; h6[g6] === i4; )
        S5++, g6++;
      for (var L6 = (h6.length - g6) * D4 + 1 >>> 0, d6 = new Uint8Array(L6); h6[g6]; ) {
        var m5 = n5[h6.charCodeAt(g6)];
        if (m5 === 255)
          return;
        for (var F4 = 0, q3 = L6 - 1; (m5 !== 0 || F4 < v8) && q3 !== -1; q3--, F4++)
          m5 += u4 * d6[q3] >>> 0, d6[q3] = m5 % 256 >>> 0, m5 = m5 / 256 >>> 0;
        if (m5 !== 0)
          throw new Error("Non-zero carry");
        v8 = F4, g6++;
      }
      if (h6[g6] !== " ") {
        for (var z6 = L6 - v8; z6 !== L6 && d6[z6] === 0; )
          z6++;
        for (var I4 = new Uint8Array(S5 + (L6 - z6)), O8 = S5; z6 !== L6; )
          I4[O8++] = d6[z6++];
        return I4;
      }
    }
...
var qr = (t, e2, n5) => {
  ...
  for (let i4 = 0; i4 < t.length; ++i4)
    for (u4 = u4 << 8 | t[i4], a3 += 8; a3 > n5; )
      a3 -= n5, s3 += e2[o6 & u4 >> a3];
  if (a3 && (s3 += e2[o6 & u4 << n5 - a3]), r3)
    for (; s3.length * n5 & 7; )
      s3 += "=";
  return s3;
};
...
var _n2 = (t, e2) => {
  for (var n5 in e2 || (e2 = {}))
    Wo2.call(e2, n5) && Rn2(t, n5, e2[n5]);
  if (Tn2)
    for (var n5 of Tn2(e2))
      Xo.call(e2, n5) && Rn2(t, n5, e2[n5]);
  return t;
};
...
async function Si({ id: t, topic: e2, wcDeepLink: n5 }) {
  ...
  try {
    ...
    if (c7 === Y.browser) {
      ...
      c7 === Y.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(s3);
  } catch (o6) {
    console.error(o6);
  }
}
...
async function Oi(t, e2) {
  let n5 = "";
  try {
    if (Yt2() && (n5 = localStorage.getItem(e2), n5))
      return n5;
...
function $t2(t = 32) {
  if (Rt2 && typeof Rt2.getRandomValues == "function")
    return Rt2.getRandomValues(new Uint8Array(t));
  if (Rt2 && typeof Rt2.randomBytes == "function")
    return Rt2.randomBytes(t);
  throw new Error("crypto.getRandomValues must be defined");
}
var tr2 = [];
var er2 = [];
...
for (let t = 0, e2 = Xt2, n5 = 1, r3 = 0; t < 24; t++) {
  ...
  for (let i4 = 0; i4 < 7; i4++)
    e2 = (e2 << Xt2 ^ (e2 >> Hi) * Ki) % qi, e2 & Di && (o6 ^= Xt2 << (Xt2 << BigInt(i4)) - Xt2);
  nr2.push(o6);
}
...
function Zi(t, e2 = 24) {
  ...
  for (let r3 = 24 - e2; r3 < 24; r3++) {
    for (let s3 = 0; s3 < 10; s3++)
      n5[s3] = t[s3] ^ t[s3 + 10] ^ t[s3 + 20] ^ t[s3 + 30] ^ t[s3 + 40];
...
var En2 = class _En extends Pe2 {
  constructor(e2, n5, r3, o6 = false, i4 = 24) {
    if (super(), this.blockLen = e2, this.suffix = n5, this.outputLen = r3, this.enableXOF = o6, this.rounds = i4, this.pos = 0, this.posOut = 0, this.finished = false, this.destroyed = false, Gt2(r3), 0 >= this.blockLen || this.blockLen >= 200)
...
var Ve2 = (t, e2) => {
  for (var n5 in e2 || (e2 = {}))
    ns.call(e2, n5) && ur2(t, n5, e2[n5]);
  if (ar2)
    for (var n5 of ar2(e2))
      rs.call(e2, n5) && ur2(t, n5, e2[n5]);
  return t;
};
...
var lr2 = (t) => {
  const e2 = t && fe2(t);
  if (e2)
    return t.includes(os) ? e2[3] : e2[1];
};
var dr2 = (t) => {
  const e2 = t && fe2(t);
  if (e2)
...
var Es = (t, e2) => {
  function n5(r3, ...o6) {
    ...
    return { encrypt(l7, f6) {
      ...
      if (tt(l7), i4 && l7.length < i4)
        throw new Error("invalid ciphertext length: smaller than tagLength=" + i4);
  ...
  for (let E7 = 0; E7 < a3; s3++) {
    ...
    if (f6 && p6 === he2) {
      ...
      for (let v8 = 0, m5; v8 < Bs; v8++)
        m5 = d6 + v8, y7[m5] = h6[m5] ^ l7[v8];
      E7 += he2;
      continue;
    }
    for (let d6 = 0, v8; d6 < p6; d6++)
      v8 = E7 + d6, i4[v8] = o6[v8] ^ u4[d6];
    E7 += p6;
  }
}
function Ns(t, e2) {
  ...
  return Ke2(o6), Ke2(s3), Ar2(i4), Ar2(n5), (c7, a3, u4, l7, f6 = 0) => {
    tt(c7), tt(a3), tt(u4);
    const h6 = u4.length;
    if (l7 === void 0 && (l7 = new Uint8Array(h6)), tt(l7), Ke2(f6), f6 < 0 || f6 >= Ur2)
      throw new Error("arx: counter overflow");
    if (l7.length < h6)
      throw new Error(`arx: output (${l7.length}) is shorter than data (${h6})`);
    const y7 = [];
    let E7 = c7.length, p6, d6;
    if (E7 === 32)
      y7.push(p6 = ze2(c7)), d6 = As;
    else if (E7 === 16 && n5)
      p6 = new Uint8Array(32), p6.set(c7), p6.set(c7, 16), d6 = Os, y7.push(p6);
    else
...
var Us = class {
  ...
  finalize() {
    ...
    for (let c7 = 2; c7 < 10; c7++)
      e2[c7] += o6, o6 = e2[c7] >>> 13, e2[c7] &= 8191;
    ...
    for (let c7 = 1; c7 < 10; c7++)
      r3[c7] = e2[c7] + o6, o6 = r3[c7] >>> 13, r3[c7] &= 8191;
    r3[9] -= 8192;
    let i4 = (o6 ^ 1) - 1;
    for (let c7 = 0; c7 < 10; c7++)
      r3[c7] &= i4;
    ...
    for (let c7 = 1; c7 < 8; c7++)
      s3 = (e2[c7] + n5[c7] | 0) + (s3 >>> 16) | 0, e2[c7] = s3 & 65535;
    Lt2(r3);
  }
  update(e2) {
    Or2(this);
...
function ks(t, e2, n5, r3 = 32) {
  if (je2(t), Gt2(r3), r3 > 255 * t.outputLen)
  ...
  for (let u4 = 0; u4 < o6; u4++)
    Ye2[0] = u4 + 1, c7.update(u4 === 0 ? jr2 : a3).update(n5).update(Ye2).digestInto(a3), i4.set(a3, t.outputLen * u4), s3._cloneInto(c7);
...
var qs = class extends Pe2 {
  ...
  digestInto(e2) {
    ...
    if (u4 > l7.length)
      throw new Error("_sha2: outputLen bigger than state");
    for (let f6 = 0; f6 < u4; f6++)
      c7.setUint32(4 * f6, l7[f6], i4);
  }
  digest() {
    const { buffer: e2, outputLen: n5 } = this;
    this.digestInto(e2);
...
function Mt2(t, e2, n5 = {}) {
  const r3 = (o6, i4, s3) => {
    ...
    if (typeof c7 != "function")
      throw new Error("invalid validator function");
    const a3 = t[o6];
    if (!(s3 && a3 === void 0) && !c7(a3, t))
      throw new Error("param " + String(o6) + " is invalid. Expected " + i4 + ", got " + a3);
  };
  for (const [o6, i4] of Object.entries(e2))
    r3(o6, i4, false);
  for (const [o6, i4] of Object.entries(n5))
    r3(o6, i4, true);
  return t;
}
var tc = () => {
...
function Hr2(t, e2, n5) {
  ...
  let r3 = H2;
  for (; e2 > q; )
    e2 & H2 && (r3 = r3 * t % n5), t = t * t % n5, e2 >>= H2;
  return r3;
}
function ot(t, e2, n5) {
  let r3 = t;
...
function rc(t) {
  ...
  for (n5 = t - H2, r3 = 0; n5 % At === q; n5 /= At, r3++)
    ;
  for (o6 = At; o6 < t && Hr2(o6, e2, t) !== t - H2; o6++)
    if (o6 > 1e3)
      throw new Error("Cannot find square root: likely non-prime P");
  if (r3 === 1) {
    const s3 = (t + H2) / tn;
  ...
  return function(c7, a3) {
    if (c7.pow(a3, e2) === c7.neg(c7.ONE))
      throw new Error("Cannot find square root");
    let u4 = r3, l7 = c7.pow(c7.mul(c7.ONE, o6), n5), f6 = c7.pow(a3, i4), h6 = c7.pow(a3, n5);
    for (; !c7.eql(h6, c7.ONE); ) {
      if (c7.eql(h6, c7.ZERO))
        return c7.ZERO;
      let y7 = 1;
      for (let p6 = c7.sqr(h6); y7 < u4 && !c7.eql(p6, c7.ONE); y7++)
        p6 = c7.sqr(p6);
...
function cc(t, e2, n5) {
  ...
  let r3 = t.ONE, o6 = e2;
  for (; n5 > q; )
    n5 & H2 && (r3 = t.mul(r3, o6)), o6 = t.sqr(o6), n5 >>= H2;
  return r3;
}
function ac(t, e2) {
...
function Kr2(t, e2, n5 = false, r3 = {}) {
  ...
  const c7 = Object.freeze({ ORDER: t, isLE: n5, BITS: o6, BYTES: i4, MASK: Xe2(o6), ZERO: q, ONE: H2, create: (a3) => X(a3, t), isValid: (a3) => {
    if (typeof a3 != "bigint")
      throw new Error("invalid field element: expected bigint, got " + typeof a3);
    return q <= a3 && a3 < t;
    ...
    if (a3.length !== i4)
      throw new Error("Field.fromBytes: expected " + i4 + " bytes, got " + a3.length);
...
function uc(t, e2, n5 = false) {
  ...
  if (r3 < 16 || r3 < i4 || r3 > 1024)
    throw new Error("expected " + i4 + "-1024 bytes of input, got " + r3);
...
function dc(t, e2) {
  return { constTimeNegate: nn2, hasPrecomputes(n5) {
    ...
    let i4 = n5;
    for (; r3 > Zr2; )
      r3 & be2 && (o6 = o6.add(i4)), i4 = i4.double(), r3 >>= be2;
    return o6;
  }, precomputeWindow(n5, r3) {
    ...
    for (let u4 = 0; u4 < o6; u4++) {
      a3 = c7, s3.push(a3);
      for (let l7 = 1; l7 < i4; l7++)
        a3 = a3.add(c7), s3.push(a3);
      c7 = a3.double();
    }
    return s3;
  }, wNAF(n5, r3, o6) {
    ...
    for (let f6 = 0; f6 < s3; f6++) {
      ...
      if (o6 === Zr2)
        break;
      let y7 = Number(o6 & a3);
      if (o6 >>= l7, y7 > c7 && (y7 -= u4, o6 += be2), y7 === 0)
        continue;
...
function hc(t, e2, n5, r3) {
  if (fc(n5, t), lc(r3, e2), n5.length !== r3.length)
    throw new Error("arrays of points and scalars must have equal length");
  ...
  for (let f6 = u4; f6 >= 0; f6 -= s3) {
    ...
    let h6 = o6;
    for (let y7 = a3.length - 1, E7 = o6; y7 > 0; y7--)
      E7 = E7.add(a3[y7]), h6 = h6.add(E7);
    if (l7 = l7.add(h6), f6 !== 0)
      for (let y7 = 0; y7 < s3; y7++)
        l7 = l7.double();
  }
  return l7;
}
...
function vc(t) {
  ...
  if (n5) {
    if (!r3.eql(o6, r3.ZERO))
      throw new Error("invalid endomorphism, can only be defined for Koblitz curves that have a=0");
    if (typeof n5 != "object" || typeof n5.beta != "bigint" || typeof n5.splitScalar != "function")
...
function Ac(t) {
  ...
  if (!n5.eql(n5.sqr(e2.Gy), s3(e2.Gx)))
  ...
  const l7 = Qe2((p6, d6) => {
    ...
    if (p6.is0()) {
      if (e2.allowInfinityPoint && !n5.is0(p6.py))
        return;
      throw new Error("bad point: ZERO");
    }
    const { x: d6, y: v8 } = p6.toAffine();
    if (!n5.isValid(d6) || !n5.isValid(v8))
  ...
  class h6 {
    constructor(d6, v8, m5) {
      if (this.px = d6, this.py = v8, this.pz = m5, d6 == null || !n5.isValid(d6))
        throw new Error("x required");
      if (v8 == null || !n5.isValid(v8))
        throw new Error("y required");
      if (m5 == null || !n5.isValid(m5))
        throw new Error("z required");
      Object.freeze(this);
    }
    static fromAffine(d6) {
      const { x: v8, y: m5 } = d6 || {};
      if (!d6 || !n5.isValid(v8) || !n5.isValid(m5))
    ...
    multiplyUnsafe(d6) {
      ...
      if (this.is0() || d6 === K2)
        return this;
      if (!v8 || E7.hasPrecomputes(this))
        return E7.wNAFCachedUnsafe(this, d6, h6.normalizeZ);
      let { k1neg: N14, k1: $5, k2neg: B3, k2: A5 } = v8.splitScalar(d6), T5 = O8, S5 = O8, L6 = this;
      for (; $5 > dt2 || A5 > dt2; )
        $5 & K2 && (T5 = T5.add(L6)), A5 & K2 && (S5 = S5.add(L6)), L6 = L6.double(), $5 >>= K2, A5 >>= K2;
...
function Ic(t) {
  ...
  function j5(g6, w7, b6, I4 = U4) {
    ...
    if (Jr2(I4), "strict" in I4)
      throw new Error("options.strict was renamed to lowS");
    if (P7 !== void 0 && P7 !== "compact" && P7 !== "der")
...
function Vc(t) {
  ...
  if (Bt2(e2) === Kt2 && typeof t.senderPublicKey > "u")
...
function pn(t) {
  if (Bt2(t.type) === ne)
    return toString3(concat3([t.type, t.sealed]), Ht2);
  if (Bt2(t.type) === Kt2) {
...
function zc(t, e2) {
  ...
  if (!_c.verify(concat3([s3, c7]), u4, l7))
...
function ca(t, e2) {
  ...
  for (const [r3, o6] of Object.entries(n5))
    o6.methods ? o6.methods = at(o6.methods, t) : o6.methods = t, o6.events = ["chainChanged", "accountsChanged"];
  return n5;
}
...
function ha(t, e2, n5) {
  ...
  if (t && xe2(t)) {
    ...
    r3 = ht2("MISSING_OR_INVALID", `${e2}, ${n5} should be an object with data`);
  return r3;
}
function Bo2(t, e2) {
  let n5 = null;
  if (t && xe2(t)) {
    ...
    n5 = ht2("MISSING_OR_INVALID", `${e2}, namespaces should be an object with data`);
  return n5;
}
function Io2(t) {
...
function sr3(r3, e2) {
  ...
  function d6(u4) {
    ...
    if (u4.length === 0)
      return "";
    for (var b6 = 0, x6 = 0, I4 = 0, D4 = u4.length; I4 !== D4 && u4[I4] === 0; )
      I4++, b6++;
    for (var j5 = (D4 - I4) * l7 + 1 >>> 0, T5 = new Uint8Array(j5); I4 !== D4; ) {
      for (var q3 = u4[I4], J5 = 0, K6 = j5 - 1; (q3 !== 0 || J5 < x6) && K6 !== -1; K6--, J5++)
        q3 += 256 * T5[K6] >>> 0, T5[K6] = q3 % a3 >>> 0, q3 = q3 / a3 >>> 0;
      if (q3 !== 0)
        throw new Error("Non-zero carry");
      x6 = J5, I4++;
    }
    for (var H4 = j5 - x6; H4 !== j5 && T5[H4] === 0; )
      H4++;
    for (var me5 = c7.repeat(b6); H4 < j5; ++H4)
      me5 += r3.charAt(T5[H4]);
    return me5;
  }
  function g6(u4) {
    ...
    var b6 = 0;
    if (u4[b6] !== " ") {
      for (var x6 = 0, I4 = 0; u4[b6] === c7; )
        x6++, b6++;
      for (var D4 = (u4.length - b6) * h6 + 1 >>> 0, j5 = new Uint8Array(D4); u4[b6]; ) {
        var T5 = t[u4.charCodeAt(b6)];
        if (T5 === 255)
          return;
        for (var q3 = 0, J5 = D4 - 1; (T5 !== 0 || q3 < I4) && J5 !== -1; J5--, q3++)
          T5 += a3 * j5[J5] >>> 0, j5[J5] = T5 % 256 >>> 0, T5 = T5 / 256 >>> 0;
        if (T5 !== 0)
          throw new Error("Non-zero carry");
        I4 = q3, b6++;
      }
      if (u4[b6] !== " ") {
        for (var K6 = D4 - I4; K6 !== D4 && j5[K6] === 0; )
          K6++;
        for (var H4 = new Uint8Array(x6 + (D4 - K6)), me5 = x6; K6 !== D4; )
          H4[me5++] = j5[K6++];
        return H4;
      }
    }
...
var vi2 = class {
  constructor(e2, t, i4) {
    this.core = e2, this.logger = t, S3(this, "name", Tt3), S3(this, "keychain"), S3(this, "randomSessionIdentifier", jc()), S3(this, "initialized", false), S3(this, "init", async () => {
      ...
      if (Fc(a3))
        return Dc(c7, o6 == null ? void 0 : o6.encoding);
      if (Kc(a3)) {
  ...
  constructor(e2, t) {
    super(e2, t), this.relayer = e2, this.logger = t, V3(this, "events", new import_events7.EventEmitter()), V3(this, "name", At2), V3(this, "queue", /* @__PURE__ */ new Map()), V3(this, "publishTimeout", (0, import_time4.toMiliseconds)(import_time4.ONE_MINUTE)), V3(this, "initialPublishTimeout", (0, import_time4.toMiliseconds)(import_time4.ONE_SECOND * 15)), V3(this, "needsTransportRestart", false), V3(this, "publish", async (i4, s3, n5) => {
      ...
      try {
        ...
        if (this.logger.debug("Failed to Publish Payload"), this.logger.error(u4), (o6 = n5 == null ? void 0 : n5.internal) != null && o6.throwOnFailedPublish)
          throw u4;
      } finally {
...
var Ti2 = class extends P2 {
  ...
  async rpcSubscribe(e2, t, i4) {
    ...
    try {
      ...
      if ((i4 == null ? void 0 : i4.transportType) === Q2.link_mode)
        return setTimeout(() => {
...
var Pi2 = (r3, e2) => {
  for (var t in e2 || (e2 = {}))
    eo3.call(e2, t) && Ye3(r3, t, e2[t]);
  if (Ci2)
    for (var t of Ci2(e2))
      to3.call(e2, t) && Ye3(r3, t, e2[t]);
  return r3;
};
...
function ye3(r3, e2, t, i4) {
  ...
  if (s3 === xi2 && (s3 = Je3), n5 === xi2 && (n5 = Je3), s3 !== n5)
    return false;
  switch (s3) {
    case ro3:
  ...
  try {
    switch (s3) {
      ...
      case Je3: {
        if (!(ye3(r3.constructor, e2.constructor, t, i4) || Ri2(r3) && Ri2(e2)))
          return false;
        const h6 = [...Object.keys(r3), ...Oi2(r3)], l7 = [...Object.keys(e2), ...Oi2(e2)];
        if (h6.length !== l7.length)
          return false;
        for (let d6 = 0; d6 < h6.length; d6++) {
          const g6 = h6[d6], _5 = r3[g6];
          if (!Object.hasOwn(e2, g6))
            return false;
          const u4 = e2[g6];
          if (!pe3(_5, u4, g6, r3, e2, t, i4))
            return false;
        }
        return true;
      }
...
var $i2 = (r3, e2) => {
  for (var t in e2 || (e2 = {}))
    xo3.call(e2, t) && Xe3(r3, t, e2[t]);
  if (Ni2)
    for (var t of Ni2(e2))
      No3.call(e2, t) && Xe3(r3, t, e2[t]);
  return r3;
};
...
var Li2 = class {
  constructor(e2, t) {
    this.core = e2, this.logger = t, p3(this, "name", Mt3), p3(this, "version", Kt3), p3(this, "events", new import_events7.default()), p3(this, "pairings"), p3(this, "initialized", false), p3(this, "storagePrefix", B2), p3(this, "ignoredPayloadTypes", [Kt2]), p3(this, "registeredMethods", []), p3(this, "init", async () => {
      ...
      if (this.pairings.keys.includes(n5)) {
        if (l7 = this.pairings.get(n5), s3.addTrace(G3.existing_pairing), l7.active)
  ...
  registerRelayerEvents() {
    this.core.relayer.on(C3.message, async (e2) => {
      ...
      if (this.pairings.keys.includes(t) && s3 !== Q2.link_mode && !this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(i4)))
        try {
...
var Ui2 = class extends M2 {
  constructor(e2, t, i4) {
    super(e2, t, i4), this.core = e2, this.logger = t, this.store = i4, w3(this, "name", Wt3), w3(this, "abortController"), w3(this, "isDevEnv"), w3(this, "verifyUrlV3", Yt3), w3(this, "storagePrefix", B2), w3(this, "version", Le3), w3(this, "publicKey"), w3(this, "fetchPromise"), w3(this, "init", async () => {
      ...
      try {
        if (o6)
          return this.validateAttestation(s3, o6);
      } catch (a3) {
        this.logger.error(a3), this.logger.warn("error validating attestation");
      }
...
var be3 = (r3, e2) => {
  for (var t in e2 || (e2 = {}))
    qo2.call(e2, t) && Ze3(r3, t, e2[t]);
  if (Ki2)
    for (var t of Ki2(e2))
      Go3.call(e2, t) && Ze3(r3, t, e2[t]);
  return r3;
};
...
var qi2 = (r3, e2) => {
  for (var t in e2 || (e2 = {}))
    Ho2.call(e2, t) && Qe3(r3, t, e2[t]);
  if (Vi2)
    for (var t of Vi2(e2))
      Yo3.call(e2, t) && Qe3(r3, t, e2[t]);
  return r3;
};
...
var Ps2 = class extends V2 {
  constructor(n5) {
    super(n5), c5(this, "name", dt3), c5(this, "events", new import_events8.default()), c5(this, "initialized", false), c5(this, "requestQueue", { state: $2.idle, queue: [] }), c5(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c5(this, "requestQueueDelay", import_time5.ONE_SECOND), c5(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c5(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c5(this, "recentlyDeletedLimit", 200), c5(this, "relayMessageCache", []), c5(this, "pendingSessions", /* @__PURE__ */ new Map()), c5(this, "init", async () => {
      ...
      if (w7)
        return await this.sendRequest({ clientRpcId: a3, relayRpcId: l7, topic: i4, method: d6, params: { request: b4(v5({}, s3), { expiryTimestamp: Ei(r3) }), chainId: t }, expiry: r3, throwOnFailedPublish: true, appLink: w7 }).catch((_5) => u4(_5)), this.client.events.emit("session_request_sent", { topic: i4, request: s3, chainId: t, id: a3 }), await p6();
      ...
      const { topic: t } = e2;
      if (this.client.session.keys.includes(t))
        await this.sendRequest({ topic: t, method: "wc_sessionDelete", params: Nt2("USER_DISCONNECTED"), throwOnFailedPublish: true }), await this.deleteSession({ topic: t, emitEvent: false });
      ...
      try {
        if (i4) {
          ...
          await Promise.all([this.sendRequest({ topic: g6, method: "wc_sessionAuthenticate", params: U4, expiry: e2.expiry, throwOnFailedPublish: true, clientRpcId: te5 }), this.sendRequest({ topic: g6, method: "wc_sessionPropose", params: q3, expiry: N11.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: q3.id })]);
      } catch (x6) {
      ...
      if (!ya(e2))
        throw new Error(ht2("MISSING_OR_INVALID", `approve() params: ${e2}`).message);
      ...
      if (Et2(r3) || this.validateSessionProps(r3, "sessionProperties"), !Et2(o6)) {
        ...
        if (!Object.keys(o6).every((u4) => h6.has(u4)))
          throw new Error(`Scoped properties must be a subset of approved namespaces, received: ${JSON.stringify(o6)}, approved namespaces: ${Array.from(h6).join(", ")}`);
      }
      ...
      if ([...new Set(t.map((a3) => Ie2(a3).namespace))].length > 1)
      ...
      try {
        ...
        const i4 = t[s3.key];
        if (oe(i4))
          return e2 === "solana_signAllTransactions" ? i4.map((r3) => Ji(r3)) : i4;
        if (typeof i4 == "string")
          return [i4];
      } catch (s3) {
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(M3.expired, async (n5) => {
      ...
      if (t && this.client.pendingRequest.keys.includes(t))
        return await this.deletePendingSessionRequest(t, ht2("EXPIRED"), true);
      if (t && this.client.auth.requests.keys.includes(t))
        return await this.deletePendingAuthRequest(t, ht2("EXPIRED"), true);
...
function _t4(s3) {
  if (G4(s3))
    return s3;
  if (Array.isArray(s3) || J4(s3) || s3 instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && s3 instanceof SharedArrayBuffer)
    return s3.slice(0);
...
function y5(s3, t, e2, i4 = /* @__PURE__ */ new Map(), n5 = void 0) {
  ...
  if (s3 instanceof Map) {
    ...
    i4.set(s3, r3);
    for (const [c7, o6] of s3)
      r3.set(c7, y5(o6, c7, e2, i4, n5));
    return r3;
  }
...
function U2(s3, t, e2, i4) {
  if (G4(s3) && (s3 = Object(s3)), t == null || typeof t != "object")
    return s3;
  if (i4.has(t))
    return _t4(i4.get(t));
  ...
  for (let a3 = 0; a3 < n5.length; a3++) {
    ...
    if (pt3(c7) && (c7 = { ...c7 }), pt3(o6) && (o6 = { ...o6 }), typeof Buffer < "u" && Buffer.isBuffer(c7) && (c7 = ht4(c7)), Array.isArray(c7))
...
var F3 = (s3, t) => {
  for (var e2 in t || (t = {}))
    pe4.call(t, e2) && ut4(s3, e2, t[e2]);
  if (dt4)
    for (var e2 of dt4(t))
      de4.call(t, e2) && ut4(s3, e2, t[e2]);
  return s3;
};
...
var wt4 = (s3, t) => {
  for (var e2 in t || (t = {}))
    ye4.call(t, e2) && K5(s3, e2, t[e2]);
  if (Pt4)
    for (var e2 of Pt4(t))
      be4.call(t, e2) && K5(s3, e2, t[e2]);
  return s3;
};
...
var Ie4 = class {
  ...
  async handleSwitchChain(t) {
    ...
    if (this.isChainApproved(a3))
      ...
      await this.client.request({ topic: t.topic, request: { method: t.request.method, params: [{ chainId: n5 }] }, chainId: (i4 = this.namespace.chains) == null ? void 0 : i4[0] }), this.setDefaultChain(`${a3}`);
    else
...
var L4 = (s3, t) => {
  for (var e2 in t || (t = {}))
    Te3.call(t, e2) && V4(s3, e2, t[e2]);
  if (bt3)
    for (var e2 of bt3(t))
      ts2.call(t, e2) && V4(s3, e2, t[e2]);
  return s3;
};
...
var g5 = (a3, t) => {
  for (var s3 in t || (t = {}))
    Q3.call(t, s3) && y6(a3, s3, t[s3]);
  if (P6)
    for (var s3 of P6(t))
      L5.call(t, s3) && y6(a3, s3, t[s3]);
  return a3;
};
...
function x5(a3) {
  ...
  if (!s3 && !h6 && !e2 && !(d6 != null && d6.length) && !(c7 != null && c7.length))
...
var w6 = class _w {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? v7(this.rpc.chains) : v7(this.rpc.optionalChains), this.signer = await es2.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storage: t.storage, storageOptions: t.storageOptions, customStoragePrefix: t.customStoragePrefix, telemetryEnabled: t.telemetryEnabled, logger: t.logger }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s3;
      try {
        const { WalletConnectModal: i4 } = await import("./dist-PBUHLI6H.js");
        s3 = i4;
      } catch {
...
@walletconnect/utils/dist/index.es.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=index.es-CR5ZHJP2.js.map
