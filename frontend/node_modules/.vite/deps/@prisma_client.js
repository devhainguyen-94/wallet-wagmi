...
var require_index_browser = __commonJS({
  "../backend/node_modules/@prisma/client/runtime/index-browser.js"(exports, module) {
    ...
    h.toFraction = function(e) {
      ...
      if (!v)
        return new N(g);
      if (f = i = new N(1), t = c = new N(0), n = new N(t), s = n.e = _e(v) - g.e - 1, o = s % m, n.d[0] = C(10, o < 0 ? m + o : o), e == null)
        e = s > 0 ? n : f;
      else {
    ...
    function oe(e, n, i) {
      if (n > fn)
        throw w = true, i && (e.precision = i), Error(De);
    ...
    function B(e, n) {
      ...
      if (n == null ? (w = false, l = E) : l = n, M.precision = l += v, i = b(q), t = i.charAt(0), Math.abs(s = N.e) < 15e14) {
        ...
        return f = oe(M, l + 2, E).times(s + ""), N = B(new M(t + "." + i.slice(1)), l - v).plus(f), M.precision = E, n == null ? p(N, E, T, w = true) : N;
        ...
        if (o = p(o.times(d), l, 1), f = c.plus(k(o, new M(r), l, 1)), b(f.d).slice(0, l) === b(c.d).slice(0, l))
          if (c = c.times(2), s !== 0 && (c = c.plus(oe(M, l + 2, E).times(s + ""))), c = k(c, new M(g), l, 1), n == null)
            if (K(c.d, l - v, T, u))
              ...
              return p(c, M.precision = E, T, w = true);
          else
    ...
    function ln(e, n) {
      ...
      if (sn.test(n))
        ...
        throw Error($ + n);
      for (s = n.search(/p/i), s > 0 ? (c = +n.slice(s + 1), n = n.substring(2, s)) : n = n.slice(2), s = n.indexOf("."), o = s >= 0, t = e.constructor, o && (n = n.replace(".", ""), u = n.length, s = u - s, r = Ze(t, new t(i), s, s * 2)), f = ie(n, i, F), l = f.length - 1, s = l; f[s] === 0; --s)
        f.pop();
